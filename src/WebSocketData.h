...
public:
    WebSocketData(bool perMessageDeflate, bool slidingCompression, WebSocketData::Deque &&backpressure) : AsyncSocketData<false>(std::move(backpressure)), WebSocketState<true>() {
